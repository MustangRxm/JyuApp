...
//            switch (msg.what){
//                case 1:
//                    List<SubscriptionFind> subFindList = (List<SubscriptionFind>) msg.obj;
//            subscriptionfind_RecyclerViewAdapter adapter = new subscriptionfind_RecyclerViewAdapter(getContext(), subFindList, R.layout.fragment_subscription_find_item);
...
//    public void MainEventReceiver(RequestSubscriptionFind event) {
...
//        msg.what = 1;
//        msg.obj = subFindList;
//        Log.i("20160616_enter bus ","SubscriptionFind size"+subFindList.size());
//        //            if (adapter == null) {
//
//
//
